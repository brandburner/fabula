...
MATCH (n) DETACH DELETE n;
    ...
    CREATE (m:GraphMetadata {
        source_file: '/home/user/fabula/output/pre_processed/echoes_of_the_past_graph.json',
        creation_timestamp: '2025-03-10T11:12:32.897414',
        version: '1.0'
    });
...
MERGE (o:Organization {uuid: 'org_starfleet_command'})
    ...
    ;
MERGE (ep:Episode {uuid: 'episode_episode_one___echoes_of_the_past'})
    ON CREATE SET
...
MERGE (ap:AgentParticipation {uuid: 'agentparticipation_agent_jean_luc_picard_event_1_1'})
    ON CREATE SET
        ...
        ap.emotional_tags = ["picard's countenance is one of measured curiosity", "authority; his exterior calm belies the deep concern stirring within as he contemplates potential threats. despite displaying the composed assurance expected of a starship captain, internally he wrestles with a blend of cautious optimism", "apprehension, aware that the outcome of this investigation may have far-reaching implications for his crew", "the federation.", "picard's countenance is one of measured curiosity and authority; his exterior calm belies the deep concern stirring within as he contemplates potential threats. despite displaying the composed assurance expected of a starship captain", "internally he wrestles with a blend of cautious optimism and apprehension", "aware that the outcome of this investigation may have far-reaching implications for his crew and the federation.", "picard's countenance is one of measured curiosity and authority", "his exterior calm belies the deep concern stirring within as he contemplates potential threats. despite displaying the composed assurance expected of a starship captain, internally he wrestles with a blend of cautious optimism and apprehension, aware that the outcome of this investigation may have far-reaching implications for his crew and the federation."],
...
MERGE (ap:AgentParticipation {uuid: 'agentparticipation_agent_jean_luc_picard_event_1_2'})
    ON CREATE SET
        ...
        ap.emotional_tags = ["picard exudes a composed", "measured exterior marked by confidence", "quiet determination. internally, he is engaged in a careful balance of curiosity", "cautious skepticism toward the unknown, experiencing a blend of intellectual excitement", "the solemn weight of command. beneath his calm demeanor, he wrestles with the implications of the anomaly, driven by a deep-seated need to protect his crew while pursuing the truth.", "picard exudes a composed and measured exterior marked by confidence and quiet determination. internally", "he is engaged in a careful balance of curiosity and cautious skepticism toward the unknown", "experiencing a blend of intellectual excitement and the solemn weight of command. beneath his calm demeanor", "he wrestles with the implications of the anomaly", "driven by a deep-seated need to protect his crew while pursuing the truth.", "picard exudes a composed and measured exterior marked by confidence and quiet determination. internally, he is engaged in a careful balance of curiosity and cautious skepticism toward the unknown, experiencing a blend of intellectual excitement and the solemn weight of command. beneath his calm demeanor, he wrestles with the implications of the anomaly, driven by a deep-seated need to protect his crew", "pursuing the truth."],
...
MERGE (ap:AgentParticipation {uuid: 'agentparticipation_agent_janina_taur_event_1_2'})
    ON CREATE SET
        ...
        ap.emotional_tags = ["taur maintains a composed exterior augmented by a quiet determination", "focus. she feels a mixture of disciplined responsibility", "the inevitable excitement of participating in a significant mission. beneath her calm professionalism, there is an undercurrent of anticipation", "a yearning for the opportunity to prove her capability in real-time interstellar operations.", "taur maintains a composed exterior augmented by a quiet determination and focus. she feels a mixture of disciplined responsibility and the inevitable excitement of participating in a significant mission. beneath her calm professionalism", "there is an undercurrent of anticipation and a yearning for the opportunity to prove her capability in real-time interstellar operations."],
...
MERGE (ap:AgentParticipation {uuid: 'agentparticipation_agent_jean_luc_picard_event_2_1'})
    ON CREATE SET
        ...
        ap.emotional_tags = ["picard exudes a calm", "reflective demeanor as he questions the sensor data, outwardly composed yet internally alert to the subtleties of interstellar signals. beneath his steady exterior lies a complex mix of cautious curiosity", "a resolute drive to understand potential threats, underscored by a quiet determination to safeguard the enterprise", "its crew.", "picard exudes a calm and reflective demeanor as he questions the sensor data", "outwardly composed yet internally alert to the subtleties of interstellar signals. beneath his steady exterior lies a complex mix of cautious curiosity and a resolute drive to understand potential threats", "underscored by a quiet determination to safeguard the enterprise and its crew."],
...
MERGE (ap:AgentParticipation {uuid: 'agentparticipation_agent_deanna_troi_event_2_1'})
    ON CREATE SET
        ...
        ap.emotional_tags = ["troi senses a layered", "multifaceted emotional current emanating from the energy readings; outwardly, she projects a calm", "thoughtful curiosity while inwardly she experiences a swirl of empathy, merging feelings of fear, longing,", "a resonant hope. this inner confluence fuels her drive to understand the emotional subtext behind the cosmic signals, even as she navigates a subtle tension between professional detachment", "personal sensitivity.", "troi senses a layered and multifaceted emotional current emanating from the energy readings; outwardly", "she projects a calm and thoughtful curiosity while inwardly she experiences a swirl of empathy", "merging feelings of fear", "longing", "and a resonant hope. this inner confluence fuels her drive to understand the emotional subtext behind the cosmic signals", "even as she navigates a subtle tension between professional detachment and personal sensitivity.", "troi senses a layered and multifaceted emotional current emanating from the energy readings", "outwardly, she projects a calm and thoughtful curiosity while inwardly she experiences a swirl of empathy, merging feelings of fear, longing, and a resonant hope. this inner confluence fuels her drive to understand the emotional subtext behind the cosmic signals, even as she navigates a subtle tension between professional detachment and personal sensitivity.", "troi senses a layered and multifaceted emotional current emanating from the energy readings; outwardly, she projects a calm and thoughtful curiosity", "inwardly she experiences a swirl of empathy, merging feelings of fear, longing, and a resonant hope. this inner confluence fuels her drive to understand the emotional subtext behind the cosmic signals, even as she navigates a subtle tension between professional detachment and personal sensitivity."],
...
MERGE (ap:AgentParticipation {uuid: 'agentparticipation_agent_william_t_riker_event_2_1'})
    ON CREATE SET
        ...
        ap.emotional_tags = ["riker\u2019s expression is a study in balanced optimism", "cautious pragmatism. while his warm smile", "confident tone suggest a natural ease with uncertainty, his attentive gaze quietly betrays a concern about the potential implications of the readings. his inner resolve to protect the crew mingles with an eagerness to explore the possibilities hinted at by the ancient signals, reflecting a complex interplay between hope", "vigilance.", "riker\u2019s expression is a study in balanced optimism and cautious pragmatism. while his warm smile and confident tone suggest a natural ease with uncertainty", "his attentive gaze quietly betrays a concern about the potential implications of the readings. his inner resolve to protect the crew mingles with an eagerness to explore the possibilities hinted at by the ancient signals", "reflecting a complex interplay between hope and vigilance."],
...
MERGE (ap:AgentParticipation {uuid: 'agentparticipation_agent_deanna_troi_event_2_2'})
    ON CREATE SET
        ...
        ap.emotional_tags = ["troi exudes a layered emotional complexity; on the surface, she is calm", "empathetic, yet beneath that serenity lies an undercurrent of apprehension", "longing. her senses pick up not just the factual data but the lingering echoes of fear", "hope, revealing an inner conflict between rational analysis", "her profound empathic perceptions.", "troi exudes a layered emotional complexity; on the surface", "she is calm and empathetic", "yet beneath that serenity lies an undercurrent of apprehension and longing. her senses pick up not just the factual data but the lingering echoes of fear and hope", "revealing an inner conflict between rational analysis and her profound empathic perceptions.", "troi exudes a layered emotional complexity", "on the surface, she is calm and empathetic, yet beneath that serenity lies an undercurrent of apprehension and longing. her senses pick up not just the factual data but the lingering echoes of fear and hope, revealing an inner conflict between rational analysis and her profound empathic perceptions.", "troi exudes a layered emotional complexity; on the surface, she is calm and empathetic, yet beneath that serenity lies an undercurrent of apprehension and longing. her senses pick up not just the factual data", "the lingering echoes of fear and hope, revealing an inner conflict between rational analysis and her profound empathic perceptions."],
...
MERGE (ap:AgentParticipation {uuid: 'agentparticipation_agent_william_t_riker_event_2_2'})
    ON CREATE SET
        ...
        ap.emotional_tags = ["riker\u2019s outward optimism is tempered by a deep-seated concern for the crew", "the potential dangers hinted at in the readings. his expressions mix approachable confidence with a measured caution, reflecting an internal dialogue that weighs intuitive judgments against the empirical data before him, all while striving to keep the team\u2019s morale steady.", "riker\u2019s outward optimism is tempered by a deep-seated concern for the crew and the potential dangers hinted at in the readings. his expressions mix approachable confidence with a measured caution", "reflecting an internal dialogue that weighs intuitive judgments against the empirical data before him", "all while striving to keep the team\u2019s morale steady.", "riker\u2019s outward optimism is tempered by a deep-seated concern for the crew and the potential dangers hinted at in the readings. his expressions mix approachable confidence with a measured caution, reflecting an internal dialogue that weighs intuitive judgments against the empirical data before him, all", "striving to keep the team\u2019s morale steady."],
...
MERGE (ap:AgentParticipation {uuid: 'agentparticipation_agent_geordi_la_forge_event_3_1'})
    ON CREATE SET
        ...
        ap.emotional_tags = ["la forge exhibits a calm", "determined demeanor, his focused gaze", "measured tone reflecting technical mastery. beneath his composed exterior, a surge of quiet excitement", "anticipation stirs, as he relishes the challenge of ensuring flawless system operation. internally, he balances pride in his engineering expertise with a sense of responsibility for the mission\u2019s success, remaining ever aware of the potential risks yet driven by an unwavering commitment to safety.", "la forge exhibits a calm and determined demeanor", "his focused gaze and measured tone reflecting technical mastery. beneath his composed exterior", "a surge of quiet excitement and anticipation stirs", "as he relishes the challenge of ensuring flawless system operation. internally", "he balances pride in his engineering expertise with a sense of responsibility for the mission\u2019s success", "remaining ever aware of the potential risks yet driven by an unwavering commitment to safety."],
...
MERGE (ap:AgentParticipation {uuid: 'agentparticipation_agent_data_event_3_2'})
    ON CREATE SET
        ...
        ap.emotional_tags = ["on the surface, data\u2019s voice remains impeccably calm", "logical, his words flowing with detached clarity. beneath this clinical exterior, however, there is a subtle undercurrent of intellectual excitement", "a yearning to grasp a nuance of human emotion. his internal state is charged with a duality: the satisfaction of technical discovery intermingled with a persistent curiosity about the deeper, almost poetic mystery of the ancient structure's origins", "significance.", "on the surface", "data\u2019s voice remains impeccably calm and logical", "his words flowing with detached clarity. beneath this clinical exterior", "however", "there is a subtle undercurrent of intellectual excitement and a yearning to grasp a nuance of human emotion. his internal state is charged with a duality: the satisfaction of technical discovery intermingled with a persistent curiosity about the deeper", "almost poetic mystery of the ancient structure's origins and significance."],
...
MERGE (ap:AgentParticipation {uuid: 'agentparticipation_agent_miles_obrien_event_3_5'})
    ON CREATE SET
        ...
        ap.emotional_tags = ["o'brien projects calm determinism; his face is set with a steady confidence while his eyes reflect an inner focus borne of years of experience. beneath his composed exterior, there lies a quiet intensity", "dedication, as he balances technical expertise with concern for the crew's safety, making sure every step of the process is flawless.", "o'brien projects calm determinism; his face is set with a steady confidence while his eyes reflect an inner focus borne of years of experience. beneath his composed exterior", "there lies a quiet intensity and dedication", "as he balances technical expertise with concern for the crew's safety", "making sure every step of the process is flawless.", "o'brien projects calm determinism", "his face is set with a steady confidence while his eyes reflect an inner focus borne of years of experience. beneath his composed exterior, there lies a quiet intensity and dedication, as he balances technical expertise with concern for the crew's safety, making sure every step of the process is flawless.", "o'brien projects calm determinism; his face is set with a steady confidence", "his eyes reflect an inner focus borne of years of experience. beneath his composed exterior, there lies a quiet intensity and dedication, as he balances technical expertise with concern for the crew's safety, making sure every step of the process is flawless."],
...
MERGE (ap:AgentParticipation {uuid: 'agentparticipation_agent_worf_event_4_1'})
    ON CREATE SET
        ...
        ap.emotional_tags = ["worf's face is a mask of controlled concern", "stoic alertness. externally, he voices apprehension about a possible trap, while internally, the instincts of a warrior", "deep-seated suspicion of unknown dangers churn within him. his focus on protecting his team is underscored by a blend of honor, duty,", "a personal readiness to face imminent threats.", "worf's face is a mask of controlled concern and stoic alertness. externally", "he voices apprehension about a possible trap", "while internally", "the instincts of a warrior and deep-seated suspicion of unknown dangers churn within him. his focus on protecting his team is underscored by a blend of honor", "duty", "and a personal readiness to face imminent threats.", "worf's face is a mask of controlled concern and stoic alertness. externally, he voices apprehension about a possible trap,", "internally, the instincts of a warrior and deep-seated suspicion of unknown dangers churn within him. his focus on protecting his team is underscored by a blend of honor, duty, and a personal readiness to face imminent threats."],
...
MERGE (ap:AgentParticipation {uuid: 'agentparticipation_agent_jean_luc_picard_event_4_1'})
    ON CREATE SET
        ...
        ap.emotional_tags = ["picard exudes a blend of thoughtful curiosity", "measured caution. his calm exterior belies an inner resolve that balances the excitement of discovery with the responsibility of command. beneath his reflective demeanor lies a careful calculation of risk", "reward, merging intellectual inquiry with an empathetic concern for his crew's wellbeing.", "picard exudes a blend of thoughtful curiosity and measured caution. his calm exterior belies an inner resolve that balances the excitement of discovery with the responsibility of command. beneath his reflective demeanor lies a careful calculation of risk and reward", "merging intellectual inquiry with an empathetic concern for his crew's wellbeing."],
...
MERGE (ap:AgentParticipation {uuid: 'agentparticipation_agent_ancient_hologram_event_4_2'})
    ON CREATE SET
        ...
        ap.emotional_tags = ["the hologram emanates a calm yet inscrutable aura, its presence seemingly untouched by time. while its tone is measured", "welcoming, there is an underlying intensity that hints at millennia of hidden sorrow, pride,", "quiet longing. its spectral expression carries the weight of an ancient legacy that both invites connection", "warns of inevitable change, leaving the away team to sense an emotional duality that defies simple explanation.", "the hologram emanates a calm yet inscrutable aura", "its presence seemingly untouched by time. while its tone is measured and welcoming", "there is an underlying intensity that hints at millennia of hidden sorrow", "pride", "and quiet longing. its spectral expression carries the weight of an ancient legacy that both invites connection and warns of inevitable change", "leaving the away team to sense an emotional duality that defies simple explanation."],
...
MERGE (ap:AgentParticipation {uuid: 'agentparticipation_agent_data_event_5_1'})
    ON CREATE SET
        ...
        ap.emotional_tags = ["beneath his characteristically unflappable exterior, data experiences an intense surge of enthusiasm", "intellectual curiosity. his logical mind buzzes with the thrill of discovery, while an almost imperceptible yearning to understand the poetic nature of this ancient wisdom underlies his composed manner. this internal complexity harmonizes his scientific passion with a subtle, reflective awe.", "beneath his characteristically unflappable exterior", "data experiences an intense surge of enthusiasm and intellectual curiosity. his logical mind buzzes with the thrill of discovery", "while an almost imperceptible yearning to understand the poetic nature of this ancient wisdom underlies his composed manner. this internal complexity harmonizes his scientific passion with a subtle", "reflective awe.", "beneath his characteristically unflappable exterior, data experiences an intense surge of enthusiasm and intellectual curiosity. his logical mind buzzes with the thrill of discovery,", "an almost imperceptible yearning to understand the poetic nature of this ancient wisdom underlies his composed manner. this internal complexity harmonizes his scientific passion with a subtle, reflective awe."],
...
MERGE (ap:AgentParticipation {uuid: 'agentparticipation_agent_ancient_hologram_event_5_2'})
    ON CREATE SET
        ...
        ap.emotional_tags = ["radiating an ancient calm fused with a silent urgency, the hologram projects an air of solemn wisdom. internally, it harbors a bittersweet longing for a lost heritage yet remains resolutely composed, its spectral presence echoing both pride in its legacy", "a quiet melancholy for what was left behind.", "radiating an ancient calm fused with a silent urgency", "the hologram projects an air of solemn wisdom. internally", "it harbors a bittersweet longing for a lost heritage yet remains resolutely composed", "its spectral presence echoing both pride in its legacy and a quiet melancholy for what was left behind."],
...
MATCH (s:Scene {uuid: 'scene_1'}),
          (ep:Episode {uuid: 'episode_episode_one___echoes_of_the_past'})
    MERGE (s)-[:PART_OF]->(ep);
