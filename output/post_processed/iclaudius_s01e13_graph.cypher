...
MATCH (n) DETACH DELETE n;
    ...
    CREATE (m:GraphMetadata { source_file: '/home/user/fabula/output/pre_processed/iclaudius_s01e13_graph.json', creation_timestamp: '2025-04-12T09:55:17.768702', version: '1.0', context_identifier: 'story_unknown_story' });
...
MERGE (ep:Episode {uuid: 'episode_old_king_log'})
    ON CREATE SET
        ...
        ep.description = '',
        ep.airdate = '', episode_number: 1
    ;
MERGE (s:Scene {uuid: 'scene_e01_scene_1'})
    ON CREATE SET
        ...
        s.scene_number = 1,
        original_uuid: 'scene_1',
        s.episode_context = 'e01'
    
    WITH s
    MATCH (l:Location {uuid: 'location_claudius_private_study'})
    MERGE (s)-[:LOCATED_IN]->(l)
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_1_event_1_1'})
    ON CREATE SET
        ...
        original_uuid: 'event_1_1',
        e.scene_uuid = 'scene_e01_scene_1',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_1_event_1_2'})
    ON CREATE SET
        ...
        original_uuid: 'event_1_2',
        e.scene_uuid = 'scene_e01_scene_1',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_1_event_1_3'})
    ON CREATE SET
        ...
        original_uuid: 'event_1_3',
        e.scene_uuid = 'scene_e01_scene_1',
        e.episode_context = 'e01'
    ;
MERGE (s:Scene {uuid: 'scene_e01_scene_2'})
    ON CREATE SET
    ...
    MERGE (s)-[:LOCATED_IN]->(l)
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_1'})
    ON CREATE SET
        ...
        original_uuid: 'event_2_1',
        e.scene_uuid = 'scene_e01_scene_2',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_2'})
    ON CREATE SET
        ...
        original_uuid: 'event_2_2',
        e.scene_uuid = 'scene_e01_scene_2',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_3'})
    ON CREATE SET
        ...
        original_uuid: 'event_2_3',
        e.scene_uuid = 'scene_e01_scene_2',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_4'})
    ON CREATE SET
        ...
        original_uuid: 'event_2_4',
        e.scene_uuid = 'scene_e01_scene_2',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_5'})
    ON CREATE SET
        ...
        original_uuid: 'event_2_5',
        e.scene_uuid = 'scene_e01_scene_2',
        e.episode_context = 'e01'
    ;
MERGE (s:Scene {uuid: 'scene_e01_scene_3'})
    ON CREATE SET
    ...
    MERGE (s)-[:LOCATED_IN]->(l)
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_3_event_3_1'})
    ON CREATE SET
        ...
        original_uuid: 'event_3_1',
        e.scene_uuid = 'scene_e01_scene_3',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_3_event_3_2'})
    ON CREATE SET
        ...
        original_uuid: 'event_3_2',
        e.scene_uuid = 'scene_e01_scene_3',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_3_event_3_3'})
    ON CREATE SET
        ...
        original_uuid: 'event_3_3',
        e.scene_uuid = 'scene_e01_scene_3',
        e.episode_context = 'e01'
    ;
MERGE (s:Scene {uuid: 'scene_e01_scene_4'})
    ON CREATE SET
    ...
    MERGE (s)-[:LOCATED_IN]->(l)
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_4_event_4_1'})
    ON CREATE SET
        ...
        original_uuid: 'event_4_1',
        e.scene_uuid = 'scene_e01_scene_4',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_4_event_4_2'})
    ON CREATE SET
        ...
        original_uuid: 'event_4_2',
        e.scene_uuid = 'scene_e01_scene_4',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_4_event_4_3'})
    ON CREATE SET
        ...
        original_uuid: 'event_4_3',
        e.scene_uuid = 'scene_e01_scene_4',
        e.episode_context = 'e01'
    ;
MERGE (s:Scene {uuid: 'scene_e01_scene_5'})
    ON CREATE SET
    ...
    MERGE (s)-[:LOCATED_IN]->(l)
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_5_event_5_1'})
    ON CREATE SET
        ...
        original_uuid: 'event_5_1',
        e.scene_uuid = 'scene_e01_scene_5',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_5_event_5_2'})
    ON CREATE SET
        ...
        original_uuid: 'event_5_2',
        e.scene_uuid = 'scene_e01_scene_5',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_5_event_5_3'})
    ON CREATE SET
        ...
        original_uuid: 'event_5_3',
        e.scene_uuid = 'scene_e01_scene_5',
        e.episode_context = 'e01'
    ;
MERGE (s:Scene {uuid: 'scene_e01_scene_6'})
    ON CREATE SET
    ...
    MERGE (s)-[:LOCATED_IN]->(l)
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_6_event_6_1'})
    ON CREATE SET
        ...
        original_uuid: 'event_6_1',
        e.scene_uuid = 'scene_e01_scene_6',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_6_event_6_2'})
    ON CREATE SET
        ...
        original_uuid: 'event_6_2',
        e.scene_uuid = 'scene_e01_scene_6',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_6_event_6_3'})
    ON CREATE SET
        ...
        e.sequence_within_scene = 3,
        e.key_dialogue = [],
        original_uuid: 'event_6_3',
        e.scene_uuid = 'scene_e01_scene_6',
        e.episode_context = 'e01'
    ;
MERGE (s:Scene {uuid: 'scene_e01_scene_7'})
    ON CREATE SET
    ...
    MERGE (s)-[:LOCATED_IN]->(l)
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_1'})
    ON CREATE SET
        ...
        original_uuid: 'event_7_1',
        e.scene_uuid = 'scene_e01_scene_7',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_2'})
    ON CREATE SET
        ...
        original_uuid: 'event_7_2',
        e.scene_uuid = 'scene_e01_scene_7',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_3'})
    ON CREATE SET
        ...
        original_uuid: 'event_7_3',
        e.scene_uuid = 'scene_e01_scene_7',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_4'})
    ON CREATE SET
        ...
        original_uuid: 'event_7_4',
        e.scene_uuid = 'scene_e01_scene_7',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_5'})
    ON CREATE SET
        ...
        original_uuid: 'event_7_5',
        e.scene_uuid = 'scene_e01_scene_7',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_6'})
    ON CREATE SET
        ...
        original_uuid: 'event_7_6',
        e.scene_uuid = 'scene_e01_scene_7',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_7'})
    ON CREATE SET
        ...
        original_uuid: 'event_7_7',
        e.scene_uuid = 'scene_e01_scene_7',
        e.episode_context = 'e01'
    ;
MERGE (s:Scene {uuid: 'scene_e01_scene_8'})
    ON CREATE SET
    ...
    MERGE (s)-[:LOCATED_IN]->(l)
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_1'})
    ON CREATE SET
        ...
        original_uuid: 'event_8_1',
        e.scene_uuid = 'scene_e01_scene_8',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_2'})
    ON CREATE SET
        ...
        original_uuid: 'event_8_2',
        e.scene_uuid = 'scene_e01_scene_8',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_3'})
    ON CREATE SET
        ...
        original_uuid: 'event_8_3',
        e.scene_uuid = 'scene_e01_scene_8',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_4'})
    ON CREATE SET
        ...
        original_uuid: 'event_8_4',
        e.scene_uuid = 'scene_e01_scene_8',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_5'})
    ON CREATE SET
        ...
        original_uuid: 'event_8_5',
        e.scene_uuid = 'scene_e01_scene_8',
        e.episode_context = 'e01'
    ;
MERGE (s:Scene {uuid: 'scene_e01_scene_9'})
    ON CREATE SET
    ...
    MERGE (s)-[:LOCATED_IN]->(l)
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_1'})
    ON CREATE SET
        ...
        original_uuid: 'event_9_1',
        e.scene_uuid = 'scene_e01_scene_9',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_2'})
    ON CREATE SET
        ...
        original_uuid: 'event_9_2',
        e.scene_uuid = 'scene_e01_scene_9',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_3'})
    ON CREATE SET
        ...
        original_uuid: 'event_9_3',
        e.scene_uuid = 'scene_e01_scene_9',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_4'})
    ON CREATE SET
        ...
        original_uuid: 'event_9_4',
        e.scene_uuid = 'scene_e01_scene_9',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_5'})
    ON CREATE SET
        ...
        original_uuid: 'event_9_5',
        e.scene_uuid = 'scene_e01_scene_9',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_6'})
    ON CREATE SET
        ...
        original_uuid: 'event_9_6',
        e.scene_uuid = 'scene_e01_scene_9',
        e.episode_context = 'e01'
    ;
MERGE (s:Scene {uuid: 'scene_e01_scene_10'})
    ON CREATE SET
    ...
    MERGE (s)-[:LOCATED_IN]->(l)
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_1'})
    ON CREATE SET
        ...
        original_uuid: 'event_10_1',
        e.scene_uuid = 'scene_e01_scene_10',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_2'})
    ON CREATE SET
        ...
        original_uuid: 'event_10_2',
        e.scene_uuid = 'scene_e01_scene_10',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_3'})
    ON CREATE SET
        ...
        original_uuid: 'event_10_3',
        e.scene_uuid = 'scene_e01_scene_10',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_4'})
    ON CREATE SET
        ...
        original_uuid: 'event_10_4',
        e.scene_uuid = 'scene_e01_scene_10',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_5'})
    ON CREATE SET
        ...
        original_uuid: 'event_10_5',
        e.scene_uuid = 'scene_e01_scene_10',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_6'})
    ON CREATE SET
        ...
        original_uuid: 'event_10_6',
        e.scene_uuid = 'scene_e01_scene_10',
        e.episode_context = 'e01'
    ;
MERGE (s:Scene {uuid: 'scene_e01_scene_11'})
    ON CREATE SET
    ...
    MERGE (s)-[:LOCATED_IN]->(l)
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_11_event_11_1'})
    ON CREATE SET
        ...
        original_uuid: 'event_11_1',
        e.scene_uuid = 'scene_e01_scene_11',
        e.episode_context = 'e01'
    ;
MERGE (s:Scene {uuid: 'scene_e01_scene_12'})
    ON CREATE SET
    ...
    MERGE (s)-[:LOCATED_IN]->(l)
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_1'})
    ON CREATE SET
        ...
        original_uuid: 'event_12_1',
        e.scene_uuid = 'scene_e01_scene_12',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_2'})
    ON CREATE SET
        ...
        original_uuid: 'event_12_2',
        e.scene_uuid = 'scene_e01_scene_12',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_3'})
    ON CREATE SET
        ...
        original_uuid: 'event_12_3',
        e.scene_uuid = 'scene_e01_scene_12',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_4'})
    ON CREATE SET
        ...
        original_uuid: 'event_12_4',
        e.scene_uuid = 'scene_e01_scene_12',
        e.episode_context = 'e01'
    ;
MERGE (s:Scene {uuid: 'scene_e01_scene_13'})
    ON CREATE SET
    ...
    MERGE (s)-[:LOCATED_IN]->(l)
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_1'})
    ON CREATE SET
        ...
        original_uuid: 'event_13_1',
        e.scene_uuid = 'scene_e01_scene_13',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_2'})
    ON CREATE SET
        ...
        original_uuid: 'event_13_2',
        e.scene_uuid = 'scene_e01_scene_13',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_3'})
    ON CREATE SET
        ...
        original_uuid: 'event_13_3',
        e.scene_uuid = 'scene_e01_scene_13',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_4'})
    ON CREATE SET
        ...
        original_uuid: 'event_13_4',
        e.scene_uuid = 'scene_e01_scene_13',
        e.episode_context = 'e01'
    ;
MERGE (e:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_5'})
    ON CREATE SET
...
MATCH (o:Object {uuid: 'object_fire'}),
    ...
    MERGE (a)-[:OWNS]->(o);
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_1_1'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_nero_event_1_1',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_1_event_1_1',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_1_1'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_agrippinilla_event_1_1',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_1_event_1_1',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_1_2'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_nero_event_1_2',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_1_event_1_2',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_1_2'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_agrippinilla_event_1_2',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_1_event_1_2',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_1_3'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_nero_event_1_3',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_1_event_1_3',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_1_3'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_agrippinilla_event_1_3',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_1_event_1_3',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_1_3'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_1_3',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_1_event_1_3',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_2_1'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_2_1',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_2_event_2_1',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_2_2'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_pallas_event_2_2',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_2_event_2_2',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_narcissus_event_2_2'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_narcissus_event_2_2',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_2_event_2_2',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_2_3'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_pallas_event_2_3',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_2_event_2_3',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_narcissus_event_2_3'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_narcissus_event_2_3',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_2_event_2_3',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_2_3'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_2_3',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_2_event_2_3',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_narcissus_event_2_4'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_narcissus_event_2_4',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_2_event_2_4',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_2_5'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_2_5',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_2_event_2_5',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_3_1'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_pallas_event_3_1',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_3_event_3_1',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_3_1'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_agrippinilla_event_3_1',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_3_event_3_1',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_3_2'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_agrippinilla_event_3_2',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_3_event_3_2',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_3_2'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_pallas_event_3_2',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_3_event_3_2',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_narcissus_event_3_2'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_narcissus_event_3_2',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_3_event_3_2',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_3_3'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_pallas_event_3_3',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_3_event_3_3',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_3_3'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_agrippinilla_event_3_3',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_3_event_3_3',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_4_1'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_4_1',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_4_event_4_1',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_4_1'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_agrippinilla_event_4_1',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_4_event_4_1',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_4_2'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_4_2',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_4_event_4_2',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_4_2'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_agrippinilla_event_4_2',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_4_event_4_2',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_4_3'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_4_3',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_4_event_4_3',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_4_3'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_agrippinilla_event_4_3',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_4_event_4_3',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_5_1'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_agrippinilla_event_5_1',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_5_event_5_1',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_5_1'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_pallas_event_5_1',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_5_event_5_1',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_5_2'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_pallas_event_5_2',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_5_event_5_2',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_5_2'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_agrippinilla_event_5_2',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_5_event_5_2',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_5_3'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_agrippinilla_event_5_3',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_5_event_5_3',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_5_3'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_pallas_event_5_3',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_5_event_5_3',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_6_1'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_6_1',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_6_event_6_1',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_6_2'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_6_2',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_6_event_6_2',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_caractacus_event_6_3'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_caractacus_event_6_3',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_6_event_6_3',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_6_3'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_6_3',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_6_event_6_3',
        ap.episode_context = 'e01'
    ;
MERGE (oi:ObjectInvolvement {uuid: 'object_involvement_objectinvolvement_object_chains_event_6_2'})
    ON CREATE SET
        ...
        original_uuid: 'objectinvolvement_object_chains_event_6_2',
        oi.event_uuid = 'event_e01_alt_scene_e01_scene_6_event_6_2',
        oi.episode_context = 'e01'
    WITH oi
    MATCH (o:Object {uuid: 'object_chains'})
    MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_6_event_6_2'})
    MERGE (o)-[:INVOLVED_IN]->(oi)
    MERGE (oi)-[:IN_EVENT]->(e);
MERGE (oi:ObjectInvolvement {uuid: 'object_involvement_objectinvolvement_object_sword_event_6_3'})
    ON CREATE SET
        ...
        original_uuid: 'objectinvolvement_object_sword_event_6_3',
        oi.event_uuid = 'event_e01_alt_scene_e01_scene_6_event_6_3',
        oi.episode_context = 'e01'
    WITH oi
    MATCH (o:Object {uuid: 'object_sword'})
    MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_6_event_6_3'})
    MERGE (o)-[:INVOLVED_IN]->(oi)
    MERGE (oi)-[:IN_EVENT]->(e);
MERGE (oi:ObjectInvolvement {uuid: 'object_involvement_objectinvolvement_object_chains_event_6_3'})
    ON CREATE SET
        ...
        original_uuid: 'objectinvolvement_object_chains_event_6_3',
        oi.event_uuid = 'event_e01_alt_scene_e01_scene_6_event_6_3',
        oi.episode_context = 'e01'
    WITH oi
    MATCH (o:Object {uuid: 'object_chains'})
    ...
    MERGE (o)-[:INVOLVED_IN]->(oi)
    MERGE (oi)-[:IN_EVENT]->(e);
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_7_1'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_7_1',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_7_event_7_1',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_7_1'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_agrippinilla_event_7_1',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_7_event_7_1',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_7_1'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_britannicus_event_7_1',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_7_event_7_1',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_7_1'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_nero_event_7_1',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_7_event_7_1',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_7_2'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_agrippinilla_event_7_2',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_7_event_7_2',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_7_2'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_britannicus_event_7_2',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_7_event_7_2',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_7_2'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_7_2',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_7_event_7_2',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_7_2'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_nero_event_7_2',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_7_event_7_2',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_7_3'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_britannicus_event_7_3',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_7_event_7_3',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_7_3'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_7_3',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_7_event_7_3',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_7_3'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_agrippinilla_event_7_3',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_7_event_7_3',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_7_3'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_nero_event_7_3',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_7_event_7_3',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_7_4'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_nero_event_7_4',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_7_event_7_4',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_7_4'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_agrippinilla_event_7_4',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_7_event_7_4',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_7_4'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_7_4',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_7_event_7_4',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_7_5'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_agrippinilla_event_7_5',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_7_event_7_5',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_7_5'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_7_5',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_7_event_7_5',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_7_6'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_agrippinilla_event_7_6',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_7_event_7_6',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_7_6'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_7_6',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_7_event_7_6',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_narcissus_event_7_7'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_narcissus_event_7_7',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_7_event_7_7',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_7_7'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_7_7',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_7_event_7_7',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_8_1'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_agrippinilla_event_8_1',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_8_event_8_1',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_8_1'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_pallas_event_8_1',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_8_event_8_1',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_8_2'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_agrippinilla_event_8_2',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_8_event_8_2',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_8_2'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_pallas_event_8_2',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_8_event_8_2',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_8_3'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_agrippinilla_event_8_3',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_8_event_8_3',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_8_3'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_pallas_event_8_3',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_8_event_8_3',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_8_3'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_nero_event_8_3',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_8_event_8_3',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_8_4'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_agrippinilla_event_8_4',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_8_event_8_4',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_8_4'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_nero_event_8_4',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_8_event_8_4',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_8_5'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_agrippinilla_event_8_5',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_8_event_8_5',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_8_5'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_nero_event_8_5',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_8_event_8_5',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_9_1'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_9_1',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_9_event_9_1',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_9_2'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_9_2',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_9_event_9_2',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_9_3'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_9_3',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_9_event_9_3',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_9_4'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_9_4',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_9_event_9_4',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_9_5'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_9_5',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_9_event_9_5',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_9_6'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_9_6',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_9_event_9_6',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_10_1'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_10_1',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_10_event_10_1',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_10_1'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_britannicus_event_10_1',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_10_event_10_1',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_narcissus_event_10_1'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_narcissus_event_10_1',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_10_event_10_1',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_10_2'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_10_2',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_10_event_10_2',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_10_2'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_britannicus_event_10_2',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_10_event_10_2',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_10_3'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_10_3',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_10_event_10_3',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_10_3'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_britannicus_event_10_3',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_10_event_10_3',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_10_4'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_10_4',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_10_event_10_4',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_10_4'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_britannicus_event_10_4',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_10_event_10_4',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_10_5'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_britannicus_event_10_5',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_10_event_10_5',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_10_5'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_10_5',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_10_event_10_5',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_10_6'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_10_6',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_10_event_10_6',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_10_6'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_britannicus_event_10_6',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_10_event_10_6',
        ap.episode_context = 'e01'
    ;
MERGE (oi:ObjectInvolvement {uuid: 'object_involvement_objectinvolvement_object_scrolls_and_maps_event_10_1'})
    ON CREATE SET
        ...
        original_uuid: 'objectinvolvement_object_scrolls_and_maps_event_10_1',
        oi.event_uuid = 'event_e01_alt_scene_e01_scene_10_event_10_1',
        oi.episode_context = 'e01'
    WITH oi
    MATCH (o:Object {uuid: 'object_scrolls_and_maps'})
    MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_1'})
    MERGE (o)-[:INVOLVED_IN]->(oi)
    MERGE (oi)-[:IN_EVENT]->(e);
MERGE (oi:ObjectInvolvement {uuid: 'object_involvement_objectinvolvement_object_scrolls_and_maps_event_10_2'})
    ON CREATE SET
        ...
        original_uuid: 'objectinvolvement_object_scrolls_and_maps_event_10_2',
        oi.event_uuid = 'event_e01_alt_scene_e01_scene_10_event_10_2',
        oi.episode_context = 'e01'
    WITH oi
    MATCH (o:Object {uuid: 'object_scrolls_and_maps'})
    MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_2'})
    MERGE (o)-[:INVOLVED_IN]->(oi)
    MERGE (oi)-[:IN_EVENT]->(e);
MERGE (oi:ObjectInvolvement {uuid: 'object_involvement_objectinvolvement_object_scrolls_and_maps_event_10_3'})
    ON CREATE SET
        ...
        original_uuid: 'objectinvolvement_object_scrolls_and_maps_event_10_3',
        oi.event_uuid = 'event_e01_alt_scene_e01_scene_10_event_10_3',
        oi.episode_context = 'e01'
    WITH oi
    MATCH (o:Object {uuid: 'object_scrolls_and_maps'})
    MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_3'})
    MERGE (o)-[:INVOLVED_IN]->(oi)
    MERGE (oi)-[:IN_EVENT]->(e);
MERGE (oi:ObjectInvolvement {uuid: 'object_involvement_objectinvolvement_object_scrolls_and_maps_event_10_4'})
    ON CREATE SET
        ...
        original_uuid: 'objectinvolvement_object_scrolls_and_maps_event_10_4',
        oi.event_uuid = 'event_e01_alt_scene_e01_scene_10_event_10_4',
        oi.episode_context = 'e01'
    WITH oi
    MATCH (o:Object {uuid: 'object_scrolls_and_maps'})
    MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_4'})
    MERGE (o)-[:INVOLVED_IN]->(oi)
    MERGE (oi)-[:IN_EVENT]->(e);
MERGE (oi:ObjectInvolvement {uuid: 'object_involvement_objectinvolvement_object_scrolls_and_maps_event_10_5'})
    ON CREATE SET
        ...
        original_uuid: 'objectinvolvement_object_scrolls_and_maps_event_10_5',
        oi.event_uuid = 'event_e01_alt_scene_e01_scene_10_event_10_5',
        oi.episode_context = 'e01'
    WITH oi
    MATCH (o:Object {uuid: 'object_scrolls_and_maps'})
    MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_5'})
    MERGE (o)-[:INVOLVED_IN]->(oi)
    MERGE (oi)-[:IN_EVENT]->(e);
MERGE (oi:ObjectInvolvement {uuid: 'object_involvement_objectinvolvement_object_scrolls_and_maps_event_10_6'})
    ON CREATE SET
        ...
        original_uuid: 'objectinvolvement_object_scrolls_and_maps_event_10_6',
        oi.event_uuid = 'event_e01_alt_scene_e01_scene_10_event_10_6',
        oi.episode_context = 'e01'
    WITH oi
    MATCH (o:Object {uuid: 'object_scrolls_and_maps'})
    MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_6'})
    MERGE (o)-[:INVOLVED_IN]->(oi)
    MERGE (oi)-[:IN_EVENT]->(e);
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_11_1'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_11_1',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_11_event_11_1',
        ap.episode_context = 'e01'
    ;
MERGE (oi:ObjectInvolvement {uuid: 'object_involvement_objectinvolvement_object_scrolls_and_maps_event_11_1'})
    ON CREATE SET
        ...
        original_uuid: 'objectinvolvement_object_scrolls_and_maps_event_11_1',
        oi.event_uuid = 'event_e01_alt_scene_e01_scene_11_event_11_1',
        oi.episode_context = 'e01'
    WITH oi
    MATCH (o:Object {uuid: 'object_scrolls_and_maps'})
    MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_11_event_11_1'})
    MERGE (o)-[:INVOLVED_IN]->(oi)
    MERGE (oi)-[:IN_EVENT]->(e);
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_12_1'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_agrippinilla_event_12_1',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_12_event_12_1',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_12_1'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_nero_event_12_1',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_12_event_12_1',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_12_2'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_nero_event_12_2',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_12_event_12_2',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_12_3'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_agrippinilla_event_12_3',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_12_event_12_3',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_12_4'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_nero_event_12_4',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_12_event_12_4',
        ap.episode_context = 'e01'
    ;
MERGE (oi:ObjectInvolvement {uuid: 'object_involvement_objectinvolvement_object_scrolls_event_12_1'})
    ON CREATE SET
        ...
        original_uuid: 'objectinvolvement_object_scrolls_event_12_1',
        oi.event_uuid = 'event_e01_alt_scene_e01_scene_12_event_12_1',
        oi.episode_context = 'e01'
    WITH oi
    MATCH (o:Object {uuid: 'object_scrolls'})
    MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_1'})
    MERGE (o)-[:INVOLVED_IN]->(oi)
    MERGE (oi)-[:IN_EVENT]->(e);
MERGE (oi:ObjectInvolvement {uuid: 'object_involvement_objectinvolvement_object_scrolls_event_12_2'})
    ON CREATE SET
        ...
        original_uuid: 'objectinvolvement_object_scrolls_event_12_2',
        oi.event_uuid = 'event_e01_alt_scene_e01_scene_12_event_12_2',
        oi.episode_context = 'e01'
    WITH oi
    MATCH (o:Object {uuid: 'object_scrolls'})
    MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_2'})
    MERGE (o)-[:INVOLVED_IN]->(oi)
    MERGE (oi)-[:IN_EVENT]->(e);
MERGE (oi:ObjectInvolvement {uuid: 'object_involvement_objectinvolvement_object_scrolls_event_12_3'})
    ON CREATE SET
        ...
        original_uuid: 'objectinvolvement_object_scrolls_event_12_3',
        oi.event_uuid = 'event_e01_alt_scene_e01_scene_12_event_12_3',
        oi.episode_context = 'e01'
    WITH oi
    MATCH (o:Object {uuid: 'object_scrolls'})
    MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_3'})
    MERGE (o)-[:INVOLVED_IN]->(oi)
    MERGE (oi)-[:IN_EVENT]->(e);
MERGE (oi:ObjectInvolvement {uuid: 'object_involvement_objectinvolvement_object_fire_event_12_3'})
    ON CREATE SET
        ...
        original_uuid: 'objectinvolvement_object_fire_event_12_3',
        oi.event_uuid = 'event_e01_alt_scene_e01_scene_12_event_12_3',
        oi.episode_context = 'e01'
    WITH oi
    MATCH (o:Object {uuid: 'object_fire'})
    ...
    MERGE (o)-[:INVOLVED_IN]->(oi)
    MERGE (oi)-[:IN_EVENT]->(e);
MERGE (oi:ObjectInvolvement {uuid: 'object_involvement_objectinvolvement_object_fire_event_12_4'})
    ON CREATE SET
        ...
        original_uuid: 'objectinvolvement_object_fire_event_12_4',
        oi.event_uuid = 'event_e01_alt_scene_e01_scene_12_event_12_4',
        oi.episode_context = 'e01'
    WITH oi
    MATCH (o:Object {uuid: 'object_fire'})
    MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_4'})
    MERGE (o)-[:INVOLVED_IN]->(oi)
    MERGE (oi)-[:IN_EVENT]->(e);
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_13_1'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_britannicus_event_13_1',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_13_event_13_1',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_narcissus_event_13_1'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_narcissus_event_13_1',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_13_event_13_1',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_sybill_event_13_2'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_sybill_event_13_2',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_13_event_13_2',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_13_2'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_13_2',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_13_event_13_2',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_13_3'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_13_3',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_13_event_13_3',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_sybill_event_13_3'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_sybill_event_13_3',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_13_event_13_3',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_sybill_event_13_4'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_sybill_event_13_4',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_13_event_13_4',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_13_4'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_13_4',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_13_event_13_4',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_sybill_event_13_5'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_sybill_event_13_5',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_13_event_13_5',
        ap.episode_context = 'e01'
    ;
MERGE (ap:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_13_5'})
    ON CREATE SET
        ...
        original_uuid: 'agentparticipation_agent_claudius_event_13_5',
        ap.event_uuid = 'event_e01_alt_scene_e01_scene_13_event_13_5',
        ap.episode_context = 'e01'
    ;
MATCH (s:Scene {uuid: 'scene_e01_scene_1'}),
          (ep:Episode {uuid: 'episode_old_king_log'})
    MERGE (s)-[:PART_OF]->(ep);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_1_event_1_1'}),
          (s:Scene {uuid: 'scene_e01_scene_1'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Agent {uuid: 'agent_nero'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_1_1'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_1_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_1_event_1_1'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_agrippinilla'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_1_1'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_1_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_1_event_1_1'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_1_event_1_2'}),
          (s:Scene {uuid: 'scene_e01_scene_1'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_1_event_1_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_1_event_1_2'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_nero'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_1_2'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_1_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_1_event_1_2'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_agrippinilla'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_1_2'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_1_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_1_event_1_2'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_1_event_1_3'}),
          (s:Scene {uuid: 'scene_e01_scene_1'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_1_event_1_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_1_event_1_3'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_nero'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_1_3'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_1_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_1_event_1_3'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_agrippinilla'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_1_3'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_1_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_1_event_1_3'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_1_3'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_1_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_1_event_1_3'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (s:Scene {uuid: 'scene_e01_scene_2'}),
          (ep:Episode {uuid: 'episode_old_king_log'})
    MERGE (s)-[:PART_OF]->(ep);
MATCH (a:Scene {uuid: 'scene_e01_scene_1'}),
          (b:Scene {uuid: 'scene_e01_scene_2'})
    MERGE (a)-[:NEXT_SCENE]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_1'}),
          (s:Scene {uuid: 'scene_e01_scene_2'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_2_1'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_2_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_1'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_2'}),
          (s:Scene {uuid: 'scene_e01_scene_2'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_2'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_pallas'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_2_2'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_2_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_2'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_narcissus'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_narcissus_event_2_2'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_narcissus_event_2_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_2'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_3'}),
          (s:Scene {uuid: 'scene_e01_scene_2'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_3'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_pallas'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_2_3'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_2_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_3'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_narcissus'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_narcissus_event_2_3'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_narcissus_event_2_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_3'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_2_3'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_2_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_3'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_4'}),
          (s:Scene {uuid: 'scene_e01_scene_2'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_4'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_narcissus'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_narcissus_event_2_4'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_narcissus_event_2_4'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_4'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_5'}),
          (s:Scene {uuid: 'scene_e01_scene_2'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_4'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_5'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_2_5'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_2_5'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_5'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (s:Scene {uuid: 'scene_e01_scene_3'}),
          (ep:Episode {uuid: 'episode_old_king_log'})
    MERGE (s)-[:PART_OF]->(ep);
MATCH (a:Scene {uuid: 'scene_e01_scene_2'}),
          (b:Scene {uuid: 'scene_e01_scene_3'})
    MERGE (a)-[:NEXT_SCENE]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_3_event_3_1'}),
          (s:Scene {uuid: 'scene_e01_scene_3'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Agent {uuid: 'agent_pallas'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_3_1'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_3_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_3_event_3_1'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_agrippinilla'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_3_1'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_3_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_3_event_3_1'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_3_event_3_2'}),
          (s:Scene {uuid: 'scene_e01_scene_3'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_3_event_3_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_3_event_3_2'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_agrippinilla'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_3_2'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_3_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_3_event_3_2'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_pallas'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_3_2'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_3_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_3_event_3_2'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_narcissus'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_narcissus_event_3_2'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_narcissus_event_3_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_3_event_3_2'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_3_event_3_3'}),
          (s:Scene {uuid: 'scene_e01_scene_3'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_3_event_3_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_3_event_3_3'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_pallas'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_3_3'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_3_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_3_event_3_3'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_agrippinilla'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_3_3'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_3_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_3_event_3_3'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (s:Scene {uuid: 'scene_e01_scene_4'}),
          (ep:Episode {uuid: 'episode_old_king_log'})
    MERGE (s)-[:PART_OF]->(ep);
MATCH (a:Scene {uuid: 'scene_e01_scene_3'}),
          (b:Scene {uuid: 'scene_e01_scene_4'})
    MERGE (a)-[:NEXT_SCENE]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_4_event_4_1'}),
          (s:Scene {uuid: 'scene_e01_scene_4'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_4_1'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_4_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_4_event_4_1'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_agrippinilla'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_4_1'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_4_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_4_event_4_1'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_4_event_4_2'}),
          (s:Scene {uuid: 'scene_e01_scene_4'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_4_event_4_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_4_event_4_2'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_4_2'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_4_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_4_event_4_2'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_agrippinilla'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_4_2'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_4_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_4_event_4_2'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_4_event_4_3'}),
          (s:Scene {uuid: 'scene_e01_scene_4'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_4_event_4_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_4_event_4_3'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_4_3'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_4_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_4_event_4_3'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_agrippinilla'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_4_3'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_4_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_4_event_4_3'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (s:Scene {uuid: 'scene_e01_scene_5'}),
          (ep:Episode {uuid: 'episode_old_king_log'})
    MERGE (s)-[:PART_OF]->(ep);
MATCH (a:Scene {uuid: 'scene_e01_scene_4'}),
          (b:Scene {uuid: 'scene_e01_scene_5'})
    MERGE (a)-[:NEXT_SCENE]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_5_event_5_1'}),
          (s:Scene {uuid: 'scene_e01_scene_5'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Agent {uuid: 'agent_agrippinilla'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_5_1'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_5_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_5_event_5_1'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_pallas'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_5_1'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_5_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_5_event_5_1'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_5_event_5_2'}),
          (s:Scene {uuid: 'scene_e01_scene_5'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_5_event_5_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_5_event_5_2'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_pallas'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_5_2'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_5_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_5_event_5_2'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_agrippinilla'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_5_2'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_5_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_5_event_5_2'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_5_event_5_3'}),
          (s:Scene {uuid: 'scene_e01_scene_5'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_5_event_5_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_5_event_5_3'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_agrippinilla'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_5_3'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_5_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_5_event_5_3'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_pallas'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_5_3'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_5_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_5_event_5_3'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (s:Scene {uuid: 'scene_e01_scene_6'}),
          (ep:Episode {uuid: 'episode_old_king_log'})
    MERGE (s)-[:PART_OF]->(ep);
MATCH (a:Scene {uuid: 'scene_e01_scene_5'}),
          (b:Scene {uuid: 'scene_e01_scene_6'})
    MERGE (a)-[:NEXT_SCENE]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_6_event_6_1'}),
          (s:Scene {uuid: 'scene_e01_scene_6'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_6_1'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_6_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_6_event_6_1'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_6_event_6_2'}),
          (s:Scene {uuid: 'scene_e01_scene_6'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_6_event_6_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_6_event_6_2'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_6_2'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_6_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_6_event_6_2'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_6_event_6_3'}),
          (s:Scene {uuid: 'scene_e01_scene_6'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_6_event_6_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_6_event_6_3'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_caractacus'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_caractacus_event_6_3'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_caractacus_event_6_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_6_event_6_3'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_6_3'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_6_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_6_event_6_3'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (s:Scene {uuid: 'scene_e01_scene_7'}),
          (ep:Episode {uuid: 'episode_old_king_log'})
    MERGE (s)-[:PART_OF]->(ep);
MATCH (a:Scene {uuid: 'scene_e01_scene_6'}),
          (b:Scene {uuid: 'scene_e01_scene_7'})
    MERGE (a)-[:NEXT_SCENE]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_1'}),
          (s:Scene {uuid: 'scene_e01_scene_7'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_7_1'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_7_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_1'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_agrippinilla'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_7_1'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_7_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_1'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_britannicus'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_7_1'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_7_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_1'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_nero'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_7_1'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_7_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_1'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_2'}),
          (s:Scene {uuid: 'scene_e01_scene_7'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_2'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_agrippinilla'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_7_2'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_7_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_2'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_britannicus'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_7_2'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_7_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_2'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_7_2'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_7_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_2'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_nero'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_7_2'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_7_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_2'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_3'}),
          (s:Scene {uuid: 'scene_e01_scene_7'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_3'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_britannicus'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_7_3'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_7_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_3'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_7_3'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_7_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_3'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_agrippinilla'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_7_3'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_7_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_3'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_nero'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_7_3'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_7_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_3'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_4'}),
          (s:Scene {uuid: 'scene_e01_scene_7'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_4'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_nero'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_7_4'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_7_4'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_4'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_agrippinilla'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_7_4'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_7_4'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_4'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_7_4'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_7_4'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_4'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_5'}),
          (s:Scene {uuid: 'scene_e01_scene_7'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_4'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_5'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_agrippinilla'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_7_5'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_7_5'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_5'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_7_5'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_7_5'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_5'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_6'}),
          (s:Scene {uuid: 'scene_e01_scene_7'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_5'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_6'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_agrippinilla'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_7_6'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_7_6'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_6'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_7_6'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_7_6'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_6'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_7'}),
          (s:Scene {uuid: 'scene_e01_scene_7'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_6'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_7'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_narcissus'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_narcissus_event_7_7'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_narcissus_event_7_7'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_7'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_7_7'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_7_7'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_7'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (s:Scene {uuid: 'scene_e01_scene_8'}),
          (ep:Episode {uuid: 'episode_old_king_log'})
    MERGE (s)-[:PART_OF]->(ep);
MATCH (a:Scene {uuid: 'scene_e01_scene_7'}),
          (b:Scene {uuid: 'scene_e01_scene_8'})
    MERGE (a)-[:NEXT_SCENE]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_1'}),
          (s:Scene {uuid: 'scene_e01_scene_8'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Agent {uuid: 'agent_agrippinilla'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_8_1'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_8_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_1'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_pallas'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_8_1'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_8_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_1'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_2'}),
          (s:Scene {uuid: 'scene_e01_scene_8'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_2'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_agrippinilla'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_8_2'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_8_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_2'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_pallas'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_8_2'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_8_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_2'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_3'}),
          (s:Scene {uuid: 'scene_e01_scene_8'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_3'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_agrippinilla'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_8_3'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_8_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_3'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_pallas'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_8_3'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_pallas_event_8_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_3'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_nero'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_8_3'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_8_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_3'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_4'}),
          (s:Scene {uuid: 'scene_e01_scene_8'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_4'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_agrippinilla'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_8_4'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_8_4'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_4'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_nero'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_8_4'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_8_4'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_4'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_5'}),
          (s:Scene {uuid: 'scene_e01_scene_8'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_4'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_5'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_agrippinilla'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_8_5'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_8_5'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_5'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_nero'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_8_5'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_8_5'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_5'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (s:Scene {uuid: 'scene_e01_scene_9'}),
          (ep:Episode {uuid: 'episode_old_king_log'})
    MERGE (s)-[:PART_OF]->(ep);
MATCH (a:Scene {uuid: 'scene_e01_scene_8'}),
          (b:Scene {uuid: 'scene_e01_scene_9'})
    MERGE (a)-[:NEXT_SCENE]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_1'}),
          (s:Scene {uuid: 'scene_e01_scene_9'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_9_1'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_9_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_1'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_2'}),
          (s:Scene {uuid: 'scene_e01_scene_9'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_2'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_9_2'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_9_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_2'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_3'}),
          (s:Scene {uuid: 'scene_e01_scene_9'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_3'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_9_3'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_9_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_3'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_4'}),
          (s:Scene {uuid: 'scene_e01_scene_9'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_4'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_9_4'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_9_4'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_4'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_5'}),
          (s:Scene {uuid: 'scene_e01_scene_9'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_4'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_5'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_9_5'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_9_5'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_5'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_6'}),
          (s:Scene {uuid: 'scene_e01_scene_9'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_5'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_6'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_9_6'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_9_6'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_6'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (s:Scene {uuid: 'scene_e01_scene_10'}),
          (ep:Episode {uuid: 'episode_old_king_log'})
    MERGE (s)-[:PART_OF]->(ep);
MATCH (a:Scene {uuid: 'scene_e01_scene_9'}),
          (b:Scene {uuid: 'scene_e01_scene_10'})
    MERGE (a)-[:NEXT_SCENE]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_1'}),
          (s:Scene {uuid: 'scene_e01_scene_10'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_10_1'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_10_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_1'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_britannicus'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_10_1'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_10_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_1'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_narcissus'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_narcissus_event_10_1'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_narcissus_event_10_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_1'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_2'}),
          (s:Scene {uuid: 'scene_e01_scene_10'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_2'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_10_2'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_10_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_2'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_britannicus'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_10_2'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_10_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_2'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_3'}),
          (s:Scene {uuid: 'scene_e01_scene_10'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_3'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_10_3'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_10_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_3'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_britannicus'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_10_3'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_10_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_3'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_4'}),
          (s:Scene {uuid: 'scene_e01_scene_10'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_4'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_10_4'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_10_4'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_4'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_britannicus'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_10_4'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_10_4'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_4'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_5'}),
          (s:Scene {uuid: 'scene_e01_scene_10'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_4'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_5'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_britannicus'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_10_5'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_10_5'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_5'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_10_5'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_10_5'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_5'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_6'}),
          (s:Scene {uuid: 'scene_e01_scene_10'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_5'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_6'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_10_6'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_10_6'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_6'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_britannicus'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_10_6'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_10_6'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_6'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (s:Scene {uuid: 'scene_e01_scene_11'}),
          (ep:Episode {uuid: 'episode_old_king_log'})
    MERGE (s)-[:PART_OF]->(ep);
MATCH (a:Scene {uuid: 'scene_e01_scene_10'}),
          (b:Scene {uuid: 'scene_e01_scene_11'})
    MERGE (a)-[:NEXT_SCENE]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_11_event_11_1'}),
          (s:Scene {uuid: 'scene_e01_scene_11'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_11_1'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_11_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_11_event_11_1'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (s:Scene {uuid: 'scene_e01_scene_12'}),
          (ep:Episode {uuid: 'episode_old_king_log'})
    MERGE (s)-[:PART_OF]->(ep);
MATCH (a:Scene {uuid: 'scene_e01_scene_11'}),
          (b:Scene {uuid: 'scene_e01_scene_12'})
    MERGE (a)-[:NEXT_SCENE]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_1'}),
          (s:Scene {uuid: 'scene_e01_scene_12'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Agent {uuid: 'agent_agrippinilla'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_12_1'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_12_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_1'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_nero'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_12_1'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_12_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_1'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_2'}),
          (s:Scene {uuid: 'scene_e01_scene_12'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_2'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_nero'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_12_2'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_12_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_2'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_3'}),
          (s:Scene {uuid: 'scene_e01_scene_12'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_3'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_agrippinilla'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_12_3'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_agrippinilla_event_12_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_3'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_4'}),
          (s:Scene {uuid: 'scene_e01_scene_12'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_4'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_nero'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_12_4'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_nero_event_12_4'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_4'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (s:Scene {uuid: 'scene_e01_scene_13'}),
          (ep:Episode {uuid: 'episode_old_king_log'})
    MERGE (s)-[:PART_OF]->(ep);
MATCH (a:Scene {uuid: 'scene_e01_scene_12'}),
          (b:Scene {uuid: 'scene_e01_scene_13'})
    MERGE (a)-[:NEXT_SCENE]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_1'}),
          (s:Scene {uuid: 'scene_e01_scene_13'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Agent {uuid: 'agent_britannicus'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_13_1'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_britannicus_event_13_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_1'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_narcissus'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_narcissus_event_13_1'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_narcissus_event_13_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_1'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_2'}),
          (s:Scene {uuid: 'scene_e01_scene_13'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_1'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_2'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_sybill'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_sybill_event_13_2'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_sybill_event_13_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_2'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_13_2'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_13_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_2'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_3'}),
          (s:Scene {uuid: 'scene_e01_scene_13'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_2'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_3'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_13_3'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_13_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_3'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_sybill'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_sybill_event_13_3'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_sybill_event_13_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_3'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_4'}),
          (s:Scene {uuid: 'scene_e01_scene_13'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_3'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_4'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_sybill'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_sybill_event_13_4'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_sybill_event_13_4'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_4'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_13_4'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_13_4'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_4'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (e:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_5'}),
          (s:Scene {uuid: 'scene_e01_scene_13'})
    MERGE (e)-[:OCCURS_IN]->(s);
MATCH (a:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_4'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_5'})
    MERGE (a)-[:NEXT_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_sybill'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_sybill_event_13_5'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_sybill_event_13_5'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_5'})
    MERGE (a)-[:IN_EVENT]->(b);
MATCH (a:Agent {uuid: 'agent_claudius'}),
          (b:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_13_5'})
    MERGE (a)-[:PARTICIPATES_IN]->(b);
MATCH (a:AgentParticipation {uuid: 'agent_participation_agentparticipation_agent_claudius_event_13_5'}),
          (b:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_5'})
    MERGE (a)-[:IN_EVENT]->(b);

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_1_event_1_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_1_event_1_2'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_1_event_1_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_1_event_1_3'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_1_event_1_2'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_1_event_1_3'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_2'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_3'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_2'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_3'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_4'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                ...
                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_3'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_4'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_5'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                ...
                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_4'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_5'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_3_event_3_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_3_event_3_2'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_3_event_3_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_3_event_3_3'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_3_event_3_2'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_3_event_3_3'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_4_event_4_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_4_event_4_2'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_4_event_4_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_4_event_4_3'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_4_event_4_2'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_4_event_4_3'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_5_event_5_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_5_event_5_2'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_5_event_5_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_5_event_5_3'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_5_event_5_2'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_5_event_5_3'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_6_event_6_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_6_event_6_2'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_6_event_6_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_6_event_6_3'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_6_event_6_2'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_6_event_6_3'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_2'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_3'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_2'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_3'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_4'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                ...
                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_3'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_4'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_5'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                ...
                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_4'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_5'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_6'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                ...
                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_5'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_6'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_7'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                ...
                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_6'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_7'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_2'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_3'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_2'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_3'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_4'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                ...
                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_3'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_4'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_5'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                ...
                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_4'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_5'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_2'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_3'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_2'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_3'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_4'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                ...
                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_3'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_4'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_5'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                ...
                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_4'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_5'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_6'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                ...
                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_5'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_6'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_2'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_3'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_2'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_3'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_4'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                ...
                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_3'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_4'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_5'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                ...
                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_4'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_5'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_6'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                ...
                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_5'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_6'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_2'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_3'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_2'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_3'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_4'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                ...
                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_3'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_4'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_2'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_3'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_2'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_3'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_4'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                ...
                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_3'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_4'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_5'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                ...
                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_4'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_5'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                ...
                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_11_event_11_1'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_1_event_1_2'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                ...
                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_1_event_1_3'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_4'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                ...
                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_3_event_3_3'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_4'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_4_event_4_3'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_4'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_5_event_5_3'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_4'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_6_event_6_3'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_4'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                ...
                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_12_event_12_4'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_5'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                ...
                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_2_event_2_5'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_6'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                ...
                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_8_event_8_5'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_6'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                ...
                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_13_event_13_5'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_6'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                ...
                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_9_event_9_6'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_7'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                

                MATCH (e1:Event {uuid: 'event_e01_alt_scene_e01_scene_10_event_10_6'}),
                      (e2:Event {uuid: 'event_e01_alt_scene_e01_scene_7_event_7_7'})
                MERGE (e1)-[:HAPPENED_BEFORE]->(e2);
                
MATCH (a:Agent)-[:PARTICIPATES_IN]->(ap:AgentParticipation)-[:IN_EVENT]->(e:Event)-[:OCCURS_IN]->(s:Scene)
        WHERE ap.episode_context = s.episode_context OR ap.episode_context IS NULL OR s.episode_context IS NULL
        WITH DISTINCT a, s
...
MATCH (a:Agent)-[:PARTICIPATES_IN]->(ap:AgentParticipation)-[:IN_EVENT]->(e:Event)<-[:IN_EVENT]-(oi:ObjectInvolvement)<-[:INVOLVED_IN]-(o:Object)
        WHERE ap.episode_context = oi.episode_context OR ap.episode_context IS NULL OR oi.episode_context IS NULL
        WITH DISTINCT a, o
        MERGE (a)-[:INTERACTED_WITH]->(o);
// // Validation: Check for scenes connected to multiple episodes
        MATCH (s:Scene)-[:PART_OF]->(e:Episode)
        WITH s, COUNT(e) AS episodeCount
        WHERE episodeCount > 1
        RETURN s.uuid AS scene_uuid, s.title AS scene_title, episodeCount AS connected_to_episodes
        LIMIT 10;
// // Validation: Check for events in scenes from different episodes
        MATCH (e:Event)-[:OCCURS_IN]->(s:Scene)-[:PART_OF]->(ep:Episode),
              (e)-[:OCCURS_IN]->(s2:Scene)-[:PART_OF]->(ep2:Episode)
        WHERE ep.uuid <> ep2.uuid
        RETURN e.uuid AS event_uuid, e.title AS event_title, 
               s.uuid AS scene1_uuid, s2.uuid AS scene2_uuid,
               ep.title AS episode1, ep2.title AS episode2
        LIMIT 10;
// Character arc query example - run with:
        // MATCH (a:Agent {name: 'Character Name'}), (ep:Episode {title: 'Episode Title'})
        // CALL {
        //   MATCH (a)-[:PARTICIPATES_IN]->(ap:AgentParticipation)-[:IN_EVENT]->(e:Event)-[:OCCURS_IN]->(s:Scene)-[:PART_OF]->(ep)
        //   WITH a, ap, e, s
        //   ORDER BY s.scene_number, e.sequence_within_scene
