...
class BamlStreamClient:
    ...
    def GenerateStoryTreatment(
        ...
        full_script: str,max_tokens: int,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[partial_types.Treatment, types.Treatment]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlSyncStream[partial_types.Treatment, types.Treatment](
        raw,
    ...
    def IdentifySceneHeadingPattern(
        ...
        script_sample: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[partial_types.SceneHeadingPatterns, types.SceneHeadingPatterns]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlSyncStream[partial_types.SceneHeadingPatterns, types.SceneHeadingPatterns](
        raw,
    ...
    def PreScanCharacters(
        ...
        full_script: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[List[partial_types.CharacterIndex], List[types.CharacterIndex]]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlSyncStream[List[partial_types.CharacterIndex], List[types.CharacterIndex]](
        raw,
    ...
    def TrackConflictTrajectory(
        ...
        all_scene_elements: List[types.SceneElements],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[List[partial_types.ConflictArc], List[types.ConflictArc]]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlSyncStream[List[partial_types.ConflictArc], List[types.ConflictArc]](
        raw,
